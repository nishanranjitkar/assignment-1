...
function App() {
  return (
    <article className="recipe">
      ...
      <p>
        “Vindaloo” is a popular Indian <a href="https:/google.com">curry dish</a> that calls for meat
      ...
      <aside>
        <p>
          ...
          >. <a href="https:/google.com">Click here</a> for an alternative recipe with less heat.
        </p>
      </aside>
    </article>
  );
